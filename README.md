...
Este proyecto implementa y valida un sistema de comunicación utilizando Radio Definida por Software (SDR) con el ADALM-Pluto y Python. 

Incluye la generación de señales, transmisión/recepción, análisis espectral y modulación/demodulación AM.
